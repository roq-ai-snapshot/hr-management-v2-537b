...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`HR Management v2`}</title>

        <meta
          name="description"
          content="Experience seamless HR operations with HR Management v2 - Your one-stop solution for managing employee data, tracking time, planning vacations, processing payrolls, and conducting performance evaluations."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless HR operations with HR Management v2 - Your one-stop solution for managing employee data, tracking time, planning vacations, processing payrolls, and conducting performance evaluations.`}
            </Text>
            <Box
